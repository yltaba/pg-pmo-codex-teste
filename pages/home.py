                            ...
                            [
                                ...
                                html.Span(
                                    ...
                                    style={
                                        "fontSize": "1rem",
                                        "textAlign": "center",
                                        "flex": "1",  # Adiciona flex: 1 para ocupar o espaço restante
                                    },
                                ),
                            ],
                            style={
...
catalog_button = dbc.Container([
    html.Div([
        html.A(
            "📊 Ver catálogo completo de visuais e indicadores",
    ...
    [
        html.Div(
            [
                ...
                # botão do catálogo (agora abaixo dos botões de navegação)
                catalog_button,
            ],
            style={
                "display": "flex",
